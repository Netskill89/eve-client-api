...
> [GetCharactersCharacterIdBookmarks200Ok] getCharactersCharacterIdBookmarks(character_id, opts)
...
var apiInstance = new EveApi.BookmarksApi();
...
apiInstance.getCharactersCharacterIdBookmarks(character_id, opts, callback);
```
...
> [GetCharactersCharacterIdBookmarksFolders200Ok] getCharactersCharacterIdBookmarksFolders(character_id, opts)
...
apiInstance.getCharactersCharacterIdBookmarksFolders(character_id, opts, callback);
```
...
> [GetCorporationsCorporationIdBookmarks200Ok] getCorporationsCorporationIdBookmarks(corporation_id, opts)
...
apiInstance.getCorporationsCorporationIdBookmarks(corporation_id, opts, callback);
```
...
> [GetCorporationsCorporationIdBookmarksFolders200Ok] getCorporationsCorporationIdBookmarksFolders(corporation_id, opts)
...
apiInstance.getCorporationsCorporationIdBookmarksFolders(corporation_id, opts, callback);
```
