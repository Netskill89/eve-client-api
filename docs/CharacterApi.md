...
> GetCharactersCharacterIdOk getCharactersCharacterId(character_id, opts)
...
var apiInstance = new EveApi.CharacterApi();
...
apiInstance.getCharactersCharacterId(character_id, opts, callback);
```
...
> [GetCharactersCharacterIdAgentsResearch200Ok] getCharactersCharacterIdAgentsResearch(character_id, opts)
...
apiInstance.getCharactersCharacterIdAgentsResearch(character_id, opts, callback);
```
...
> [GetCharactersCharacterIdBlueprints200Ok] getCharactersCharacterIdBlueprints(character_id, opts)
...
apiInstance.getCharactersCharacterIdBlueprints(character_id, opts, callback);
```
...
> [GetCharactersCharacterIdCorporationhistory200Ok] getCharactersCharacterIdCorporationhistory(character_id, opts)
...
apiInstance.getCharactersCharacterIdCorporationhistory(character_id, opts, callback);
```
...
> GetCharactersCharacterIdFatigueOk getCharactersCharacterIdFatigue(character_id, opts)
...
apiInstance.getCharactersCharacterIdFatigue(character_id, opts, callback);
```
...
> [GetCharactersCharacterIdMedals200Ok] getCharactersCharacterIdMedals(character_id, opts)
...
apiInstance.getCharactersCharacterIdMedals(character_id, opts, callback);
```
...
> [GetCharactersCharacterIdNotifications200Ok] getCharactersCharacterIdNotifications(character_id, opts)
...
apiInstance.getCharactersCharacterIdNotifications(character_id, opts, callback);
```
...
> [GetCharactersCharacterIdNotificationsContacts200Ok] getCharactersCharacterIdNotificationsContacts(character_id, opts)
...
apiInstance.getCharactersCharacterIdNotificationsContacts(character_id, opts, callback);
```
...
> GetCharactersCharacterIdPortraitOk getCharactersCharacterIdPortrait(character_id, opts)
...
apiInstance.getCharactersCharacterIdPortrait(character_id, opts, callback);
```
...
> GetCharactersCharacterIdRolesOk getCharactersCharacterIdRoles(character_id, opts)
...
apiInstance.getCharactersCharacterIdRoles(character_id, opts, callback);
```
...
> [GetCharactersCharacterIdStandings200Ok] getCharactersCharacterIdStandings(character_id, opts)
...
apiInstance.getCharactersCharacterIdStandings(character_id, opts, callback);
```
...
> [GetCharactersCharacterIdTitles200Ok] getCharactersCharacterIdTitles(character_id, opts)
...
apiInstance.getCharactersCharacterIdTitles(character_id, opts, callback);
```
...
var characters = [new EveApi.[Number]()]; // [Number] | The character IDs to fetch affiliations for. All characters must exist, or none will be returned
...
> 'Number' postCharactersCharacterIdCspa(character_idcharacters, opts)
...
var characters = [new EveApi.[Number]()]; // [Number] | The target characters to calculate the charge for
...
apiInstance.postCharactersCharacterIdCspa(character_idcharacters, opts, callback);
```
