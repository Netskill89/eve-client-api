...
> GetCharactersCharacterIdSearchOk getCharactersCharacterIdSearch(categories, character_idsearch, opts)
...
var apiInstance = new EveApi.SearchApi();
...
apiInstance.getCharactersCharacterIdSearch(categories, character_idsearch, opts, callback);
```
