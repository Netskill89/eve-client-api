...
> GetCharactersCharacterIdAttributesOk getCharactersCharacterIdAttributes(character_id, opts)
...
var apiInstance = new EveApi.SkillsApi();
...
apiInstance.getCharactersCharacterIdAttributes(character_id, opts, callback);
```
...
> [GetCharactersCharacterIdSkillqueue200Ok] getCharactersCharacterIdSkillqueue(character_id, opts)
...
apiInstance.getCharactersCharacterIdSkillqueue(character_id, opts, callback);
```
...
> GetCharactersCharacterIdSkillsOk getCharactersCharacterIdSkills(character_id, opts)
...
apiInstance.getCharactersCharacterIdSkills(character_id, opts, callback);
```
