...
> GetCharactersCharacterIdFwStatsOk getCharactersCharacterIdFwStats(character_id, opts)
...
var apiInstance = new EveApi.FactionWarfareApi();
...
apiInstance.getCharactersCharacterIdFwStats(character_id, opts, callback);
```
...
> GetCorporationsCorporationIdFwStatsOk getCorporationsCorporationIdFwStats(corporation_id, opts)
...
apiInstance.getCorporationsCorporationIdFwStats(corporation_id, opts, callback);
```
