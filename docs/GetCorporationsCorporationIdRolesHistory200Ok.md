# EveApi.GetCorporationsCorporationIdRolesHistory200Ok

## Properties
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**changed_at** | **Date** | changed_at string | 
**character_id** | **Number** | The character whose roles are changed | 
**issuer_id** | **Number** | ID of the character who issued this change | 
