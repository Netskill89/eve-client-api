...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetCharactersCharacterIdFwStatsOk', function() {
      beforeEach(function() {
        instance = new EveApi.GetCharactersCharacterIdFwStatsOk();
      });
      ...
      it('should create an instance of GetCharactersCharacterIdFwStatsOk', function() {
        ...
        expect(instance).to.be.a(EveApi.GetCharactersCharacterIdFwStatsOk);
      });

      it('should have the property current_rank (base name: "current_rank")', function() {
        // TODO: update the code to test the property current_rank
        expect(instance).to.have.property('current_rank');
        // expect(instance.current_rank).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property highest_rank (base name: "highest_rank")', function() {
        // TODO: update the code to test the property highest_rank
        expect(instance).to.have.property('highest_rank');
        // expect(instance.highest_rank).to.be(expectedValueLiteral);
      });
