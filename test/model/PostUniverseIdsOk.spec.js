...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostUniverseIdsOk', function() {
      ...
      it('should have the property inventory_types (base name: "inventory_types")', function() {
        // TODO: update the code to test the property inventory_types
        expect(instance).to.have.property('inventory_types');
        // expect(instance.inventory_types).to.be(expectedValueLiteral);
      });
