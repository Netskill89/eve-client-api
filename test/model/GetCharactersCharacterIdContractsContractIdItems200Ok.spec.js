...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetCharactersCharacterIdContractsContractIdItems200Ok', function() {
      beforeEach(function() {
        instance = new EveApi.GetCharactersCharacterIdContractsContractIdItems200Ok();
      });
      ...
      it('should create an instance of GetCharactersCharacterIdContractsContractIdItems200Ok', function() {
        ...
        expect(instance).to.be.a(EveApi.GetCharactersCharacterIdContractsContractIdItems200Ok);
      });
