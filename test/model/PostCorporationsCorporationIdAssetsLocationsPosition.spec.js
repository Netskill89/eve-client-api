...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PostCorporationsCorporationIdAssetsLocationsPosition', function() {
      beforeEach(function() {
        instance = new EveApi.PostCorporationsCorporationIdAssetsLocationsPosition();
      });
      ...
      it('should create an instance of PostCorporationsCorporationIdAssetsLocationsPosition', function() {
        ...
        expect(instance).to.be.a(EveApi.PostCorporationsCorporationIdAssetsLocationsPosition);
      });
