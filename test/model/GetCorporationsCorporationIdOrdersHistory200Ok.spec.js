...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetCorporationsCorporationIdOrdersHistory200Ok', function() {
      beforeEach(function() {
        instance = new EveApi.GetCorporationsCorporationIdOrdersHistory200Ok();
      });
      ...
      it('should create an instance of GetCorporationsCorporationIdOrdersHistory200Ok', function() {
        ...
        expect(instance).to.be.a(EveApi.GetCorporationsCorporationIdOrdersHistory200Ok);
      });
      ...
      it('should have the property issued_by (base name: "issued_by")', function() {
        // TODO: update the code to test the property issued_by
        expect(instance).to.have.property('issued_by');
        // expect(instance.issued_by).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property wallet_division (base name: "wallet_division")', function() {
        // TODO: update the code to test the property wallet_division
        expect(instance).to.have.property('wallet_division');
        // expect(instance.wallet_division).to.be(expectedValueLiteral);
      });
