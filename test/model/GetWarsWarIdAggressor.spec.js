...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetWarsWarIdAggressor', function() {
      ...
      it('should have the property isk_destroyed (base name: "isk_destroyed")', function() {
        // TODO: update the code to test the property isk_destroyed
        expect(instance).to.have.property('isk_destroyed');
        // expect(instance.isk_destroyed).to.be(expectedValueLiteral);
      });

      it('should have the property ships_killed (base name: "ships_killed")', function() {
        // TODO: update the code to test the property ships_killed
        expect(instance).to.have.property('ships_killed');
        // expect(instance.ships_killed).to.be(expectedValueLiteral);
      });
