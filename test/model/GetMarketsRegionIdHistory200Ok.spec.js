...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetMarketsRegionIdHistory200Ok', function() {
      beforeEach(function() {
        instance = new EveApi.GetMarketsRegionIdHistory200Ok();
      });
      ...
      it('should create an instance of GetMarketsRegionIdHistory200Ok', function() {
        ...
        expect(instance).to.be.a(EveApi.GetMarketsRegionIdHistory200Ok);
      });
      ...
      it('should have the property order_count (base name: "order_count")', function() {
        // TODO: update the code to test the property order_count
        expect(instance).to.have.property('order_count');
        // expect(instance.order_count).to.be(expectedValueLiteral);
      });
