...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetCorporationsCorporationIdWalletsDivisionTransactions200Ok', function() {
      beforeEach(function() {
        instance = new EveApi.GetCorporationsCorporationIdWalletsDivisionTransactions200Ok();
      });
      ...
      it('should create an instance of GetCorporationsCorporationIdWalletsDivisionTransactions200Ok', function() {
        ...
        expect(instance).to.be.a(EveApi.GetCorporationsCorporationIdWalletsDivisionTransactions200Ok);
      });
