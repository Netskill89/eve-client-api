...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetFwLeaderboardsCorporationsVictoryPoints = factory(root.EveApi.ApiClient, root.EveApi.GetFwLeaderboardsCorporationsActiveTotalActiveTotal1, root.EveApi.GetFwLeaderboardsCorporationsLastWeekLastWeek1, root.EveApi.GetFwLeaderboardsCorporationsYesterdayYesterday1);
  }
   ...
   * @class
   * @param active_total {Array.<module:model/GetFwLeaderboardsCorporationsActiveTotalActiveTotal1>} Top 10 ranking of corporations active in faction warfare by total victory points. A corporation is considered \"active\" if they have participated in faction warfare in the past 14 days
   * @param last_week {Array.<module:model/GetFwLeaderboardsCorporationsLastWeekLastWeek1>} Top 10 ranking of corporations by victory points in the past week
