...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetCorporationsCorporationIdRoles200Ok = factory(root.EveApi.ApiClient);
  }
  ...
  /**
   * Allowed values for the <code>grantable_roles</code> property.
   * @enum {String}
   * @readonly
   */
  ...
  /**
   * Allowed values for the <code>grantable_roles_at_base</code> property.
   * @enum {String}
   * @readonly
   */
  ...
  /**
   * Allowed values for the <code>grantable_roles_at_hq</code> property.
   * @enum {String}
   * @readonly
   */
  ...
  /**
   * Allowed values for the <code>grantable_roles_at_other</code> property.
   * @enum {String}
   * @readonly
   */
