...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetCorporationsCorporationIdWalletsDivisionTransactions200Ok = factory(root.EveApi.ApiClient);
  }
   ...
   * @param journal_ref_id {Number} -1 if there is no corresponding wallet journal entry
   ...
   */
  var exports = function(client_id, _date, is_buy, journal_ref_id, location_id, quantity, transaction_id, type_id, unit_price) {
