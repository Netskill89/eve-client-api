...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetSovereigntyStructures200Ok = factory(root.EveApi.ApiClient);
  }
   ...
   * @class
   * @param alliance_id {Number} The alliance that owns the structure. 
   * @param solar_system_id {Number} Solar system in which the structure is located. 
   * @param structure_id {Number} Unique item ID for this structure.
   * @param structure_type_id {Number} A reference to the type of structure this is. 
   */
  var exports = function(alliance_id, solar_system_id, structure_id, structure_type_id) {
