...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetFwLeaderboardsCharactersVictoryPoints = factory(root.EveApi.ApiClient, root.EveApi.GetFwLeaderboardsCharactersActiveTotalActiveTotal1, root.EveApi.GetFwLeaderboardsCharactersLastWeekLastWeek1, root.EveApi.GetFwLeaderboardsCharactersYesterdayYesterday1);
  }
   ...
   * @class
   * @param active_total {Array.<module:model/GetFwLeaderboardsCharactersActiveTotalActiveTotal1>} Top 100 ranking of pilots active in faction warfare by total victory points. A pilot is considered \"active\" if they have participated in faction warfare in the past 14 days
   * @param last_week {Array.<module:model/GetFwLeaderboardsCharactersLastWeekLastWeek1>} Top 100 ranking of pilots by victory points in the past week
