...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetCorporationsCorporationIdOrders200Ok = factory(root.EveApi.ApiClient);
  }
   ...
   * @param issued_by {Number} The character who issued this order
   * @param location_id {Number} ID of the location where order was placed
   * @param order_id {Number} Unique order ID
   ...
   * @param region_id {Number} ID of the region where order was placed
   * @param type_id {Number} The type ID of the item transacted in this order
   * @param volume_remain {Number} Quantity of items still required or offered
   * @param volume_total {Number} Quantity of items required or offered at time order was placed
   * @param wallet_division {Number} The corporation wallet division used for this order.
   */
  var exports = function(duration, issued, issued_by, location_id, order_id, price, range, region_id, type_id, volume_remain, volume_total, wallet_division) {
   ...
   */
  exports.prototype.issued_by = undefined;
