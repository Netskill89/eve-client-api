...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetCharactersCharacterIdPlanetsPlanetIdLink = factory(root.EveApi.ApiClient);
  }
   ...
   * @param link_level {Number} link_level integer
   * @param source_pin_id {Number} source_pin_id integer
   */
  var exports = function(destination_pin_id, link_level, source_pin_id) {
