...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetCharactersCharacterIdCorporationhistory200Ok = factory(root.EveApi.ApiClient);
  }
   ...
   * @param record_id {Number} An incrementing ID that can be used to canonically establish order of records in cases where dates may be ambiguous
   * @param start_date {Date} start_date string
   */
  var exports = function(corporation_id, record_id, start_date) {
