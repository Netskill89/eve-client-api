...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetUniverseConstellationsConstellationIdOk = factory(root.EveApi.ApiClient, root.EveApi.GetUniverseConstellationsConstellationIdPosition);
  }
   ...
   * @class
   * @param constellation_id {Number} constellation_id integer
   * @param name {String} name string
   * @param position {module:model/GetUniverseConstellationsConstellationIdPosition} 
   * @param region_id {Number} The region this constellation is in
   * @param systems {Array.<Number>} systems array
   */
  var exports = function(constellation_id, name, position, region_id, systems) {
