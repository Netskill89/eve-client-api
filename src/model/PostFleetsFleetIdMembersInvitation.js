...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.PostFleetsFleetIdMembersInvitation = factory(root.EveApi.ApiClient);
  }
   ...
   * @class
   * @param character_id {Number} The character you want to invite
   ...
   */
  var exports = function(character_id, role) {
