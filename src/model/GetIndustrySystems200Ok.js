...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetIndustrySystems200Ok = factory(root.EveApi.ApiClient, root.EveApi.GetIndustrySystemsCostIndice);
  }
   ...
   * @class
   * @param cost_indices {Array.<module:model/GetIndustrySystemsCostIndice>} cost_indices array
   * @param solar_system_id {Number} solar_system_id integer
   */
  var exports = function(cost_indices, solar_system_id) {
