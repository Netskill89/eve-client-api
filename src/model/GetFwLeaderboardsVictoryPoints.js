...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetFwLeaderboardsVictoryPoints = factory(root.EveApi.ApiClient, root.EveApi.GetFwLeaderboardsActiveTotalActiveTotal1, root.EveApi.GetFwLeaderboardsLastWeekLastWeek1, root.EveApi.GetFwLeaderboardsYesterdayYesterday1);
  }
   ...
   * @class
   * @param active_total {Array.<module:model/GetFwLeaderboardsActiveTotalActiveTotal1>} Top 4 ranking of factions active in faction warfare by total victory points. A faction is considered \"active\" if they have participated in faction warfare in the past 14 days
   * @param last_week {Array.<module:model/GetFwLeaderboardsLastWeekLastWeek1>} Top 4 ranking of factions by victory points in the past week
