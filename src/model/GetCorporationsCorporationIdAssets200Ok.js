...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetCorporationsCorporationIdAssets200Ok = factory(root.EveApi.ApiClient);
  }
   ...
   * @class
   * @param is_singleton {Boolean} is_singleton boolean
   * @param item_id {Number} item_id integer
   * @param location_flag {module:model/GetCorporationsCorporationIdAssets200Ok.LocationFlagEnum} location_flag string
   * @param location_id {Number} location_id integer
   * @param location_type {module:model/GetCorporationsCorporationIdAssets200Ok.LocationTypeEnum} location_type string
   * @param quantity {Number} quantity integer
   * @param type_id {Number} type_id integer
   */
  var exports = function(is_singleton, item_id, location_flag, location_id, location_type, quantity, type_id) {
