...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetKillmailsKillmailIdKillmailHashItem = factory(root.EveApi.ApiClient, root.EveApi.GetKillmailsKillmailIdKillmailHashItemsItem);
  }
   ...
   * @param item_type_id {Number} item_type_id integer
   * @param singleton {Number} singleton integer
   */
  var exports = function(flag, item_type_id, singleton) {
    this.flag = flag;
