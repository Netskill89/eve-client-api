...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.PostFleetsFleetIdWingsCreated = factory(root.EveApi.ApiClient);
  }
   ...
   * @class
   * @param wing_id {Number} The wing_id of the newly created wing
   */
  var exports = function(wing_id) {
