...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetCharactersCharacterIdWalletJournal200Ok = factory(root.EveApi.ApiClient);
  }
   ...
   * @param ref_type {module:model/GetCharactersCharacterIdWalletJournal200Ok.RefTypeEnum} \"The transaction type for the given. transaction. Different transaction types will populate different attributes.\"
   */
  var exports = function(_date, description, id, ref_type) {
    this._date = _date;
   ...
   */
  exports.prototype.context_id_type = undefined;
