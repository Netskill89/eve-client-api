...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetKillmailsKillmailIdKillmailHashVictim = factory(root.EveApi.ApiClient, root.EveApi.GetKillmailsKillmailIdKillmailHashItem, root.EveApi.GetKillmailsKillmailIdKillmailHashPosition);
  }
   ...
   * @class
   * @param damage_taken {Number} How much total damage was taken by the victim 
   * @param ship_type_id {Number} The ship that the victim was piloting and was destroyed 
   */
  var exports = function(damage_taken, ship_type_id) {
