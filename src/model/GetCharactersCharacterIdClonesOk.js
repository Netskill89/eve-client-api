...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetCharactersCharacterIdClonesOk = factory(root.EveApi.ApiClient, root.EveApi.GetCharactersCharacterIdClonesHomeLocation, root.EveApi.GetCharactersCharacterIdClonesJumpClone);
  }
   ...
   * @class
   * @param jump_clones {Array.<module:model/GetCharactersCharacterIdClonesJumpClone>} jump_clones array
   */
  var exports = function(jump_clones) {
   ...
   */
  exports.prototype.last_clone_jump_date = undefined;

  /**
   * last_station_change_date string
   * @member {Date} last_station_change_date
   */
  exports.prototype.last_station_change_date = undefined;
