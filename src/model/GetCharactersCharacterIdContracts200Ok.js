...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetCharactersCharacterIdContracts200Ok = factory(root.EveApi.ApiClient);
  }
   ...
   * @class
   * @param acceptor_id {Number} Who will accept the contract
   * @param assignee_id {Number} ID to whom the contract is assigned, can be alliance, corporation or character ID
   ...
   * @param for_corporation {Boolean} true if the contract was issued on behalf of the issuer's corporation
   ...
   */
  var exports = function(acceptor_id, assignee_id, availability, contract_id, date_expired, date_issued, for_corporation, issuer_corporation_id, issuer_id, status, type) {
