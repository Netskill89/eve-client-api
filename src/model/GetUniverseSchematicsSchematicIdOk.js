...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetUniverseSchematicsSchematicIdOk = factory(root.EveApi.ApiClient);
  }
   ...
   * @class
   * @param cycle_time {Number} Time in seconds to process a run
   * @param schematic_name {String} schematic_name string
   */
  var exports = function(cycle_time, schematic_name) {
