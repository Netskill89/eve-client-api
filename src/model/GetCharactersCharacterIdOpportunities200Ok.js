...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetCharactersCharacterIdOpportunities200Ok = factory(root.EveApi.ApiClient);
  }
   ...
   * @class
   * @param completed_at {Date} completed_at string
   * @param task_id {Number} task_id integer
   */
  var exports = function(completed_at, task_id) {
