...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetFwLeaderboardsCharactersKills = factory(root.EveApi.ApiClient, root.EveApi.GetFwLeaderboardsCharactersActiveTotalActiveTotal, root.EveApi.GetFwLeaderboardsCharactersLastWeekLastWeek, root.EveApi.GetFwLeaderboardsCharactersYesterdayYesterday);
  }
   ...
   * @class
   * @param active_total {Array.<module:model/GetFwLeaderboardsCharactersActiveTotalActiveTotal>} Top 100 ranking of pilots active in faction warfare by total kills. A pilot is considered \"active\" if they have participated in faction warfare in the past 14 days
   * @param last_week {Array.<module:model/GetFwLeaderboardsCharactersLastWeekLastWeek>} Top 100 ranking of pilots by kills in the past week
