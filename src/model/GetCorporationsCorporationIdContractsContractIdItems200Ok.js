...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetCorporationsCorporationIdContractsContractIdItems200Ok = factory(root.EveApi.ApiClient);
  }
   ...
   * @param record_id {Number} Unique ID for the item
   * @param type_id {Number} Type ID for item
   */
  var exports = function(is_included, is_singleton, quantity, record_id, type_id) {
