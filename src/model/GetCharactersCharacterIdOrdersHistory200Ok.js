...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetCharactersCharacterIdOrdersHistory200Ok = factory(root.EveApi.ApiClient);
  }
   ...
   * @param is_corporation {Boolean} Signifies whether the buy/sell order was placed on behalf of a corporation.
   ...
   */
  var exports = function(duration, is_corporation, issued, location_id, order_id, price, range, region_id, state, type_id, volume_remain, volume_total) {
