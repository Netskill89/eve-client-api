...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetFwStats200Ok = factory(root.EveApi.ApiClient, root.EveApi.GetFwStatsKills, root.EveApi.GetFwStatsVictoryPoints);
  }
   ...
   * @param systems_controlled {Number} The number of solar systems controlled by the given faction
   * @param victory_points {module:model/GetFwStatsVictoryPoints} 
   */
  var exports = function(faction_id, kills, pilots, systems_controlled, victory_points) {
