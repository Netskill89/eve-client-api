...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetCorporationsCorporationIdContracts200Ok = factory(root.EveApi.ApiClient);
  }
   ...
   * @param assignee_id {Number} ID to whom the contract is assigned, can be corporation or character ID
