...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetCorporationsCorporationIdStandings200Ok = factory(root.EveApi.ApiClient);
  }
   ...
   * @class
   * @param from_id {Number} from_id integer
   * @param from_type {module:model/GetCorporationsCorporationIdStandings200Ok.FromTypeEnum} from_type string
   * @param standing {Number} standing number
   */
  var exports = function(from_id, from_type, standing) {
