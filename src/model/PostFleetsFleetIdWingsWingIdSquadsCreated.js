...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.PostFleetsFleetIdWingsWingIdSquadsCreated = factory(root.EveApi.ApiClient);
  }
   ...
   * @class
   * @param squad_id {Number} The squad_id of the newly created squad
   */
  var exports = function(squad_id) {
