...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetIncursions200Ok = factory(root.EveApi.ApiClient);
  }
   ...
   * @class
   * @param constellation_id {Number} The constellation id in which this incursion takes place
   * @param faction_id {Number} The attacking faction's id
   * @param has_boss {Boolean} Whether the final encounter has boss or not
   * @param infested_solar_systems {Array.<Number>} A list of infested solar system ids that are a part of this incursion
   * @param influence {Number} Influence of this incursion as a float from 0 to 1
   * @param staging_solar_system_id {Number} Staging solar system for this incursion
   ...
   */
  var exports = function(constellation_id, faction_id, has_boss, infested_solar_systems, influence, staging_solar_system_id, state, type) {
