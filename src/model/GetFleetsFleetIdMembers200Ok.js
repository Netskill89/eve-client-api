...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetFleetsFleetIdMembers200Ok = factory(root.EveApi.ApiClient);
  }
   ...
   * @param join_time {Date} join_time string
   * @param role {module:model/GetFleetsFleetIdMembers200Ok.RoleEnum} Member’s role in fleet
   * @param role_name {String} Localized role names
   * @param ship_type_id {Number} ship_type_id integer
   * @param solar_system_id {Number} Solar system the member is located in
   * @param squad_id {Number} ID of the squad the member is in. If not applicable, will be set to -1
   * @param takes_fleet_warp {Boolean} Whether the member take fleet warps
   * @param wing_id {Number} ID of the wing the member is in. If not applicable, will be set to -1
   */
  var exports = function(character_id, join_time, role, role_name, ship_type_id, solar_system_id, squad_id, takes_fleet_warp, wing_id) {
