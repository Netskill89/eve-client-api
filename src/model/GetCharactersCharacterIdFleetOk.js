...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetCharactersCharacterIdFleetOk = factory(root.EveApi.ApiClient);
  }
   ...
   * @class
   * @param fleet_id {Number} The character's current fleet ID
   ...
   */
  var exports = function(fleet_id, role, squad_id, wing_id) {
