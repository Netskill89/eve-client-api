...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetSovereigntyCampaignsParticipant = factory(root.EveApi.ApiClient);
  }
   ...
   * @class
   * @param alliance_id {Number} alliance_id integer
   * @param score {Number} score number
   */
  var exports = function(alliance_id, score) {
