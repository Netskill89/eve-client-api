...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetCharactersCharacterIdSkillqueue200Ok = factory(root.EveApi.ApiClient);
  }
   ...
   * @class
   * @param finished_level {Number} finished_level integer
   * @param queue_position {Number} queue_position integer
   * @param skill_id {Number} skill_id integer
   */
  var exports = function(finished_level, queue_position, skill_id) {
