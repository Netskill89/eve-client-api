...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.GetWarsWarIdAggressor = factory(root.EveApi.ApiClient);
  }
   ...
   * @class
   * @param isk_destroyed {Number} ISK value of ships the aggressor has destroyed
   * @param ships_killed {Number} The number of ships the aggressor has killed
   */
