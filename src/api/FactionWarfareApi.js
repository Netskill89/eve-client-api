...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.FactionWarfareApi = factory(root.EveApi.ApiClient, root.EveApi.BadRequest, root.EveApi.ErrorLimited, root.EveApi.Forbidden, root.EveApi.GatewayTimeout, root.EveApi.GetCharactersCharacterIdFwStatsOk, root.EveApi.GetCorporationsCorporationIdFwStatsOk, root.EveApi.GetFwLeaderboardsCharactersOk, root.EveApi.GetFwLeaderboardsCorporationsOk, root.EveApi.GetFwLeaderboardsOk, root.EveApi.GetFwStats200Ok, root.EveApi.GetFwSystems200Ok, root.EveApi.GetFwWars200Ok, root.EveApi.InternalServerError, root.EveApi.ServiceUnavailable, root.EveApi.Unauthorized);
  }
  ...
  var exports = function(apiClient) {
     ...
     */
    this.getCharactersCharacterIdFwStats = function(character_id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'character_id' is set
      if (character_id === undefined || character_id === null) {
        throw new Error("Missing the required parameter 'character_id' when calling getCharactersCharacterIdFwStats");
      }
     ...
     */
    this.getCorporationsCorporationIdFwStats = function(corporation_id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'corporation_id' is set
      if (corporation_id === undefined || corporation_id === null) {
        throw new Error("Missing the required parameter 'corporation_id' when calling getCorporationsCorporationIdFwStats");
      }
