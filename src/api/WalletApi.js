...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.WalletApi = factory(root.EveApi.ApiClient, root.EveApi.BadRequest, root.EveApi.ErrorLimited, root.EveApi.Forbidden, root.EveApi.GatewayTimeout, root.EveApi.GetCharactersCharacterIdWalletJournal200Ok, root.EveApi.GetCharactersCharacterIdWalletTransactions200Ok, root.EveApi.GetCorporationsCorporationIdWallets200Ok, root.EveApi.GetCorporationsCorporationIdWalletsDivisionJournal200Ok, root.EveApi.GetCorporationsCorporationIdWalletsDivisionTransactions200Ok, root.EveApi.InternalServerError, root.EveApi.ServiceUnavailable, root.EveApi.Unauthorized);
  }
  ...
  var exports = function(apiClient) {
     ...
     */
    this.getCharactersCharacterIdWallet = function(character_id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'character_id' is set
      if (character_id === undefined || character_id === null) {
        throw new Error("Missing the required parameter 'character_id' when calling getCharactersCharacterIdWallet");
      }
     ...
     */
    this.getCharactersCharacterIdWalletJournal = function(character_id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'character_id' is set
      if (character_id === undefined || character_id === null) {
        throw new Error("Missing the required parameter 'character_id' when calling getCharactersCharacterIdWalletJournal");
      }
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/String} opts.datasource The server name you would like data from (default to tranquility)
     * @param {Number} opts.from_id Only show transactions happened before the one referenced by this id
     * @param {String} opts.If_None_Match ETag from a previous request. A 304 will be returned if this matches the current ETag
     * @param {String} opts.token Access token to use if unable to set a header
     ...
     */
    this.getCharactersCharacterIdWalletTransactions = function(character_id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'character_id' is set
      if (character_id === undefined || character_id === null) {
        throw new Error("Missing the required parameter 'character_id' when calling getCharactersCharacterIdWalletTransactions");
      }
     ...
     */
    this.getCorporationsCorporationIdWallets = function(corporation_id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'corporation_id' is set
      if (corporation_id === undefined || corporation_id === null) {
        throw new Error("Missing the required parameter 'corporation_id' when calling getCorporationsCorporationIdWallets");
      }
     ...
     */
    this.getCorporationsCorporationIdWalletsDivisionJournal = function(corporation_id, division, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'corporation_id' is set
      if (corporation_id === undefined || corporation_id === null) {
        throw new Error("Missing the required parameter 'corporation_id' when calling getCorporationsCorporationIdWalletsDivisionJournal");
      }
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/String} opts.datasource The server name you would like data from (default to tranquility)
     * @param {Number} opts.from_id Only show journal entries happened before the transaction referenced by this id
     * @param {String} opts.If_None_Match ETag from a previous request. A 304 will be returned if this matches the current ETag
     * @param {String} opts.token Access token to use if unable to set a header
     ...
     */
    this.getCorporationsCorporationIdWalletsDivisionTransactions = function(corporation_id, division, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'corporation_id' is set
      if (corporation_id === undefined || corporation_id === null) {
        throw new Error("Missing the required parameter 'corporation_id' when calling getCorporationsCorporationIdWalletsDivisionTransactions");
      }
