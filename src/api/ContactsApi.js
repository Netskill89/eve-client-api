...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.ContactsApi = factory(root.EveApi.ApiClient, root.EveApi.BadRequest, root.EveApi.ErrorLimited, root.EveApi.Forbidden, root.EveApi.GatewayTimeout, root.EveApi.GetAlliancesAllianceIdContacts200Ok, root.EveApi.GetAlliancesAllianceIdContactsLabels200Ok, root.EveApi.GetCharactersCharacterIdContacts200Ok, root.EveApi.GetCharactersCharacterIdContactsLabels200Ok, root.EveApi.GetCorporationsCorporationIdContacts200Ok, root.EveApi.GetCorporationsCorporationIdContactsLabels200Ok, root.EveApi.InternalServerError, root.EveApi.PostCharactersCharacterIdContactsError520, root.EveApi.ServiceUnavailable, root.EveApi.Unauthorized);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @param {Array.<Number>} contact_ids A list of contacts to delete
     ...
     */
    this.deleteCharactersCharacterIdContacts = function(character_id, contact_ids, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'character_id' is set
      if (character_id === undefined || character_id === null) {
        throw new Error("Missing the required parameter 'character_id' when calling deleteCharactersCharacterIdContacts");
      }

      // verify the required parameter 'contact_ids' is set
      if (contact_ids === undefined || contact_ids === null) {
        throw new Error("Missing the required parameter 'contact_ids' when calling deleteCharactersCharacterIdContacts");
      }
     ...
     */
    this.getAlliancesAllianceIdContacts = function(alliance_id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'alliance_id' is set
      if (alliance_id === undefined || alliance_id === null) {
        throw new Error("Missing the required parameter 'alliance_id' when calling getAlliancesAllianceIdContacts");
      }
     ...
     */
    this.getAlliancesAllianceIdContactsLabels = function(alliance_id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'alliance_id' is set
      if (alliance_id === undefined || alliance_id === null) {
        throw new Error("Missing the required parameter 'alliance_id' when calling getAlliancesAllianceIdContactsLabels");
      }
     ...
     */
    this.getCharactersCharacterIdContacts = function(character_id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'character_id' is set
      if (character_id === undefined || character_id === null) {
        throw new Error("Missing the required parameter 'character_id' when calling getCharactersCharacterIdContacts");
      }
     ...
     */
    this.getCharactersCharacterIdContactsLabels = function(character_id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'character_id' is set
      if (character_id === undefined || character_id === null) {
        throw new Error("Missing the required parameter 'character_id' when calling getCharactersCharacterIdContactsLabels");
      }
     ...
     */
    this.getCorporationsCorporationIdContacts = function(corporation_id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'corporation_id' is set
      if (corporation_id === undefined || corporation_id === null) {
        throw new Error("Missing the required parameter 'corporation_id' when calling getCorporationsCorporationIdContacts");
      }
     ...
     */
    this.getCorporationsCorporationIdContactsLabels = function(corporation_id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'corporation_id' is set
      if (corporation_id === undefined || corporation_id === null) {
        throw new Error("Missing the required parameter 'corporation_id' when calling getCorporationsCorporationIdContactsLabels");
      }
     ...
     * @param {Number} character_id An EVE character ID
     * @param {Array.<module:model/Number>} contact_ids A list of contacts
     * @param {Number} standing Standing for the contact
     * @param {Object} opts Optional parameters
     * @param {module:model/String} opts.datasource The server name you would like data from (default to tranquility)
     * @param {Array.<Number>} opts.label_ids Add custom labels to the new contact
     * @param {String} opts.token Access token to use if unable to set a header
     ...
     */
    this.postCharactersCharacterIdContacts = function(character_id, contact_ids, standing, opts, callback) {
      opts = opts || {};
      var postBody = contact_ids;

      // verify the required parameter 'character_id' is set
      if (character_id === undefined || character_id === null) {
        throw new Error("Missing the required parameter 'character_id' when calling postCharactersCharacterIdContacts");
      }

      // verify the required parameter 'contact_ids' is set
      if (contact_ids === undefined || contact_ids === null) {
        throw new Error("Missing the required parameter 'contact_ids' when calling postCharactersCharacterIdContacts");
      }
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/String} opts.datasource The server name you would like data from (default to tranquility)
     * @param {Array.<Number>} opts.label_ids Add custom labels to the contact
     * @param {String} opts.token Access token to use if unable to set a header
     * @param {Boolean} opts.watched Whether the contact should be watched, note this is only effective on characters (default to false)
     ...
     */
    this.putCharactersCharacterIdContacts = function(character_id, contact_ids, standing, opts, callback) {
      opts = opts || {};
      var postBody = contact_ids;

      // verify the required parameter 'character_id' is set
      if (character_id === undefined || character_id === null) {
        throw new Error("Missing the required parameter 'character_id' when calling putCharactersCharacterIdContacts");
      }

      // verify the required parameter 'contact_ids' is set
      if (contact_ids === undefined || contact_ids === null) {
        throw new Error("Missing the required parameter 'contact_ids' when calling putCharactersCharacterIdContacts");
      }
