...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.CalendarApi = factory(root.EveApi.ApiClient, root.EveApi.BadRequest, root.EveApi.ErrorLimited, root.EveApi.Forbidden, root.EveApi.GatewayTimeout, root.EveApi.GetCharactersCharacterIdCalendar200Ok, root.EveApi.GetCharactersCharacterIdCalendarEventIdAttendees200Ok, root.EveApi.GetCharactersCharacterIdCalendarEventIdAttendeesNotFound, root.EveApi.GetCharactersCharacterIdCalendarEventIdNotFound, root.EveApi.GetCharactersCharacterIdCalendarEventIdOk, root.EveApi.InternalServerError, root.EveApi.PutCharactersCharacterIdCalendarEventIdResponse, root.EveApi.ServiceUnavailable, root.EveApi.Unauthorized);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @param {Number} opts.from_event The event ID to retrieve events from
     ...
     */
    this.getCharactersCharacterIdCalendar = function(character_id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'character_id' is set
      if (character_id === undefined || character_id === null) {
        throw new Error("Missing the required parameter 'character_id' when calling getCharactersCharacterIdCalendar");
      }
     ...
     */
    this.getCharactersCharacterIdCalendarEventId = function(character_id, event_id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'character_id' is set
      if (character_id === undefined || character_id === null) {
        throw new Error("Missing the required parameter 'character_id' when calling getCharactersCharacterIdCalendarEventId");
      }

      // verify the required parameter 'event_id' is set
      if (event_id === undefined || event_id === null) {
        throw new Error("Missing the required parameter 'event_id' when calling getCharactersCharacterIdCalendarEventId");
      }
     ...
     */
    this.getCharactersCharacterIdCalendarEventIdAttendees = function(character_id, event_id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'character_id' is set
      if (character_id === undefined || character_id === null) {
        throw new Error("Missing the required parameter 'character_id' when calling getCharactersCharacterIdCalendarEventIdAttendees");
      }

      // verify the required parameter 'event_id' is set
      if (event_id === undefined || event_id === null) {
        throw new Error("Missing the required parameter 'event_id' when calling getCharactersCharacterIdCalendarEventIdAttendees");
      }
     ...
     */
    this.putCharactersCharacterIdCalendarEventId = function(character_id, event_id, response, opts, callback) {
      opts = opts || {};
      var postBody = response;

      // verify the required parameter 'character_id' is set
      if (character_id === undefined || character_id === null) {
        throw new Error("Missing the required parameter 'character_id' when calling putCharactersCharacterIdCalendarEventId");
      }

      // verify the required parameter 'event_id' is set
      if (event_id === undefined || event_id === null) {
        throw new Error("Missing the required parameter 'event_id' when calling putCharactersCharacterIdCalendarEventId");
      }
