...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.OpportunitiesApi = factory(root.EveApi.ApiClient, root.EveApi.BadRequest, root.EveApi.ErrorLimited, root.EveApi.Forbidden, root.EveApi.GatewayTimeout, root.EveApi.GetCharactersCharacterIdOpportunities200Ok, root.EveApi.GetOpportunitiesGroupsGroupIdOk, root.EveApi.GetOpportunitiesTasksTaskIdOk, root.EveApi.InternalServerError, root.EveApi.ServiceUnavailable, root.EveApi.Unauthorized);
  }
  ...
  var exports = function(apiClient) {
     ...
     */
    this.getCharactersCharacterIdOpportunities = function(character_id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'character_id' is set
      if (character_id === undefined || character_id === null) {
        throw new Error("Missing the required parameter 'character_id' when calling getCharactersCharacterIdOpportunities");
      }
     ...
     */
    this.getOpportunitiesGroupsGroupId = function(group_id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'group_id' is set
      if (group_id === undefined || group_id === null) {
        throw new Error("Missing the required parameter 'group_id' when calling getOpportunitiesGroupsGroupId");
      }
     ...
     */
    this.getOpportunitiesTasksTaskId = function(task_id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'task_id' is set
      if (task_id === undefined || task_id === null) {
        throw new Error("Missing the required parameter 'task_id' when calling getOpportunitiesTasksTaskId");
      }
