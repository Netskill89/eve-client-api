...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EveApi.WarsApi = factory(root.EveApi.ApiClient, root.EveApi.BadRequest, root.EveApi.ErrorLimited, root.EveApi.GatewayTimeout, root.EveApi.GetWarsWarIdKillmails200Ok, root.EveApi.GetWarsWarIdKillmailsUnprocessableEntity, root.EveApi.GetWarsWarIdOk, root.EveApi.GetWarsWarIdUnprocessableEntity, root.EveApi.InternalServerError, root.EveApi.ServiceUnavailable);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @param {Number} opts.max_war_id Only return wars with ID smaller than this
     ...
     */
    this.getWarsWarId = function(war_id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'war_id' is set
      if (war_id === undefined || war_id === null) {
        throw new Error("Missing the required parameter 'war_id' when calling getWarsWarId");
      }
     ...
     */
    this.getWarsWarIdKillmails = function(war_id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'war_id' is set
      if (war_id === undefined || war_id === null) {
        throw new Error("Missing the required parameter 'war_id' when calling getWarsWarIdKillmails");
      }
